...
export default function HolidaysTable({ selectedLanguage }) {
        ...
        <>
            {selectedLanguage === 'ar' ? (<View style={{ marginHorizontal: 25, backgroundColor: 'white', elevation: 1, shadowColor: 'gray', borderRadius: 5, padding: 10 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15, marginTop: 5, marginBottom: 5 }}>
                    ...
                    <Text style={{ fontSize: 13.5, fontWeight: 700, color: 'darkblue', marginLeft: 2 }}>{t('dashboard.holiday-title')}</Text>
                ...
                <View style={{ marginTop: 18, marginBottom: 5 }}>
                    {renderHoliday(t('dashboard.not-specified'), '1', t('dashboard.not-specified'), selectedLanguage)}
                </View>
            </View>)
                ...
                (<View style={{ marginHorizontal: 25, backgroundColor: 'white', elevation: 1, shadowColor: 'gray', borderRadius: 5, padding: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15, marginTop: 5, marginBottom: 5 }}>
                        <Text style={{ fontSize: 13.2, fontWeight: 700, color: 'darkblue', marginLeft: 2 }}>{t('dashboard.holiday-title')}</Text>
...
const renderHoliday = (name, number, date, selectedLanguage) => {
    return (
