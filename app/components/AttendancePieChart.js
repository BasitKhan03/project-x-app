...
export default function AttendancePieChart({ present, absent, leave, late, selectedLanguage }) {
            ...
            >
                <View style={{ width: '85%', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', borderRadius: 5, elevation: 1.5, shadowColor: 'gray', paddingTop: 21, paddingBottom: 26, alignSelf: 'center' }}>
                    <View style={{ marginBottom: 22, alignItems: 'center' }}>
                        <Text style={{ fontSize: selectedLanguage === 'ar' ? 15.2 : 14.5, marginBottom: 3, fontWeight: 700, color: 'darkblue' }}>{t('dashboard.presence-in')}</Text>
                    ...
                    <View style={{ marginTop: 25, flexDirection: 'row', justifyContent: 'space-evenly', width: '100%', paddingHorizontal: 20 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ alignItems: 'center', marginLeft: 5 }}>
                                <Text style={{ fontSize: 12.5, marginBottom: 2 }}>{t('dashboard.present')}</Text>
                                {allZero1 ? (
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ alignItems: 'center', marginLeft: 5 }}>
                                <Text style={{ fontSize: 12.5, marginBottom: 2 }}>{t('dashboard.absent')}</Text>
                                {allZero1 ? (
                                    <Text style={{ fontSize: 12, fontWeight: 700, top: 1 }}>N/a</Text>
                                ) : (
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ alignItems: 'center', marginLeft: 5 }}>
                                <Text style={{ fontSize: 12.5, marginBottom: 2 }}>{t('dashboard.leave')}</Text>
                                {allZero1 ? (
                                    <Text style={{ fontSize: 12, fontWeight: 700, top: 1 }}>N/a</Text>
                                ) : (
                ...
                <View style={{ width: '85%', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', borderRadius: 5, elevation: 1.5, shadowColor: 'gray', paddingTop: 21, paddingBottom: 26, alignSelf: 'center' }}>
                    <View style={{ marginBottom: 22, alignItems: 'center' }}>
                        <Text style={{ fontSize: 14.5, marginBottom: 3, fontWeight: 700, color: 'darkblue' }}>{t('dashboard.punctuality-in')}</Text>
                        <Text style={{ fontSize: selectedLanguage === 'ar' ? 12.5 : 13, color: 'gray' }}>{getCurrentMonthYear()}</Text>
                    </View>
                    <View>
                        <PieChart
                    ...
                    <View style={{ marginTop: 25, flexDirection: 'row', justifyContent: 'space-evenly', width: '100%', paddingHorizontal: 30 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ alignItems: 'center', marginLeft: 5 }}>
                                <Text style={{ fontSize: 12.5, marginBottom: 2 }}>{t('dashboard.on-time')}</Text>
                                {allZero2 ? (
                                    <Text style={{ fontSize: 12, fontWeight: 700, top: 1 }}>N/a</Text>
                                ) : (
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                            ...
                            <View style={{ alignItems: 'center', marginLeft: 5 }}>
                                <Text style={{ fontSize: 12.5, marginBottom: 2 }}>{t('dashboard.late')}</Text>
                                {allZero2 ? (
                                    <Text style={{ fontSize: 12, fontWeight: 700, top: 1 }}>N/a</Text>
                                ) : (
